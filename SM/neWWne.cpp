...
namespace spinas {
  ...
  neWWne::neWWne(const ldouble& echarge, const ldouble& masse, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ):
  ...
  void neWWne::set_masses(const ldouble& masse, const ldouble& massW){
    me=masse;
    prope.set_mass(me);
    MW=massW;
  ...
  void neWWne::set_momenta(const ldouble mom1[4], const ldouble mom2[4], const ldouble mom3[4], const ldouble mom4[4]){
    //Particles
  ...
  cdouble neWWne::amp(const int& ds3, const int& ds2){//Double Spin
  ...
  int test_neWWne(){
    ...
    {//amp^2
      ...
      neWWne neWWneAmp = neWWne(EE,me,MW,SW,0);
      ...
      i += neWWneAmp.test_2to2_amp2([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH);
      i += neWWneAmp.test_2to2_amp2_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH);
      i += neWWneAmp.test_2to2_amp2_boosts([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH);
      i += neWWneAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH);
      ...
      i += neWWneAmp.test_2to2_amp2([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH2);
      i += neWWneAmp.test_2to2_amp2_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH2);
      i += neWWneAmp.test_2to2_amp2_boosts([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH2);
      i += neWWneAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH2);
      //std::cout<<"\n# me=125.1, MW=80.385, pspatial=95\n";
      me = 125.1;
      pspatial = 95;
      neWWneAmp.set_masses(me,MW);
      ...
      i += neWWneAmp.test_2to2_amp2([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH4);
      i += neWWneAmp.test_2to2_amp2_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH4);
      i += neWWneAmp.test_2to2_amp2_boosts([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH4);
      i += neWWneAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH4);
      ...
      i += neWWneAmp.test_2to2_amp2([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH3);
      i += neWWneAmp.test_2to2_amp2_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH3);
      i += neWWneAmp.test_2to2_amp2_boosts([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH3);
      i += neWWneAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neWWneAmp.amp2(); }, 0,MW,MW,0,pspatial,dataCH3);
      // Done
