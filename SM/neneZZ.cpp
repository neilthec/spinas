...
namespace spinas {
  ...
  neneZZ::neneZZ(const ldouble& echarge, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ):
  ...
  void neneZZ::set_masses(const ldouble& massW){
    MW=massW;
  ...
  void neneZZ::set_momenta(const ldouble mom1[4], const ldouble mom2[4], const ldouble mom3[4], const ldouble mom4[4]){
    //Particles
  ...
  cdouble neneZZ::amp(const int& ds3, const int& ds4){//Double Spin
  ...
  int test_neneZZ(){
    ...
    {//amp^2
      ...
      neneZZ neneZZAmp = neneZZ(EE,MW,SW,0);
      ...
      i += neneZZAmp.test_2to2_amp2([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH);
      i += neneZZAmp.test_2to2_amp2_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH);
      i += neneZZAmp.test_2to2_amp2_boosts([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH);
      i += neneZZAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH);
      ...
      i += neneZZAmp.test_2to2_amp2([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH2);
      i += neneZZAmp.test_2to2_amp2_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH2);
      i += neneZZAmp.test_2to2_amp2_boosts([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH2);
      i += neneZZAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH2);
      ...
      i += neneZZAmp.test_2to2_amp2([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH4);
      i += neneZZAmp.test_2to2_amp2_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH4);
      i += neneZZAmp.test_2to2_amp2_boosts([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH4);
      i += neneZZAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH4);
      //std::cout<<"\n# MW=8.0, pspatial=125.1\n";
      pspatial = 125.1;
      MW=8;
      MZ=MW/CW;
      neneZZAmp.set_masses(MW);
      ...
      i += neneZZAmp.test_2to2_amp2([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH3);
      i += neneZZAmp.test_2to2_amp2_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH3);
      i += neneZZAmp.test_2to2_amp2_boosts([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH3);
      i += neneZZAmp.test_2to2_amp2_boosts_and_rotations([&]() { return neneZZAmp.amp2(); }, 0,0,MZ,MZ,pspatial,dataCH3);
      // Done
