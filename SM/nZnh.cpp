...
namespace spinas {
  ...
  nZnh::nZnh(const ldouble& echarge, const ldouble& massh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ):
  ...
  void nZnh::set_masses(const ldouble& massh, const ldouble& massW){
    mh=massh;
    MW=massW;
  ...
  void nZnh::set_momenta(const ldouble mom1[4], const ldouble mom2[4], const ldouble mom3[4], const ldouble mom4[4]){
    //Particles
  ...
  cdouble nZnh::amp(const int& ds2){//Double Spin
  ...
  int test_nZnh(){
    ...
    {//amp^2
      ...
      nZnh nZnhAmp = nZnh(EE,mh,MW,SW,0);
      ...
      i += nZnhAmp.test_2to2_amp2([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH);
      i += nZnhAmp.test_2to2_amp2_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH);
      i += nZnhAmp.test_2to2_amp2_boosts([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH);
      i += nZnhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH);
      ...
      i += nZnhAmp.test_2to2_amp2([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH2);
      i += nZnhAmp.test_2to2_amp2_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH2);
      i += nZnhAmp.test_2to2_amp2_boosts([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH2);
      i += nZnhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH2);
      //std::cout<<"\n# mh=0.0005, MW=80.385, pspatial=125.1\n";
      mh = 0.0005;
      pspatial = 125.1;
      nZnhAmp.set_masses(mh,MW);
      ...
      i += nZnhAmp.test_2to2_amp2([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH3);
      i += nZnhAmp.test_2to2_amp2_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH3);
      i += nZnhAmp.test_2to2_amp2_boosts([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH3);
      i += nZnhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nZnhAmp.amp2(); }, 0,MZ,0,mh,pspatial,dataCH3);
      // Done
