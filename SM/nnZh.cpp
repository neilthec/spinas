...
namespace spinas {
  ...
  nnZh::nnZh(const ldouble& echarge, const ldouble& massh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ):
  ...
  void nnZh::set_momenta(const ldouble mom1[4], const ldouble mom2[4], const ldouble mom3[4], const ldouble mom4[4]){
    //Particles
  ...
  cdouble nnZh::amp(const int& ds3){//Double Spin
  ...
  int test_nnZh(){
    ...
    {//amp^2
      ...
      nnZh nnZhAmp = nnZh(EE,mh,MW,SW,0);
      ...
      i += nnZhAmp.test_2to2_amp2([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH);
      i += nnZhAmp.test_2to2_amp2_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH);
      i += nnZhAmp.test_2to2_amp2_boosts([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH);
      i += nnZhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH);
      ...
      i += nnZhAmp.test_2to2_amp2([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH2);
      i += nnZhAmp.test_2to2_amp2_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH2);
      i += nnZhAmp.test_2to2_amp2_boosts([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH2);
      i += nnZhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH2);
      //std::cout<<"\n# mh=0.0005, MW=80.385, pspatial=125.1\n";
      mh = 0.0005;
      pspatial = 125.1;
      nnZhAmp.set_masses(mh,MW);
      ...
      i += nnZhAmp.test_2to2_amp2([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH3);
      i += nnZhAmp.test_2to2_amp2_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH3);
      i += nnZhAmp.test_2to2_amp2_boosts([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH3);
      i += nnZhAmp.test_2to2_amp2_boosts_and_rotations([&]() { return nnZhAmp.amp2(); }, 0,0,MZ,mh,pspatial,dataCH3);
      // Done
