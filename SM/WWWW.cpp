...
namespace spinas {
  ...
  void WWWW::set_momenta(const ldouble mom1[4], const ldouble mom2[4], const ldouble mom3[4], const ldouble mom4[4]){
    ...
    pDenUh=proph.den(propUP);
    pDenTZ=propZ.den(propTP);
    pDenUZ=propZ.den(propUP);
    pDenTA=propA.den(propTP);
    pDenUA=propA.den(propUP);
    //Mandelstahms
  ...
  cdouble WWWW::amp(const int& ds1, const int& ds2, const int& ds3, const int& ds4){//Double Spin
    ...
    for(int i=0;i<nCombs;i++){
      ...
      //34 out:
      //(2s12<13><24>[13][24]+(<13><24>[14][23]+<14><23>[13][24]+((4<34>[12][13]+(-3<23>[14]+3(<14>+2[14])[23]-4[13][24])<13>+(4<23>[14]+(<14>-3[14])[23]+<12>[34])[13])<24>+(-3(<34>[12]+<23>[14]+<14>[23]+<12>[34])[13]+(<34>[12]+4<23>[14]+(<14>-3[14])[23]+4<12>[34])<13>)[24])CW^2 )MZ^2 -3(([24][123>-[23][431>)<24>[13]+(([23][124>-[13][432>)[24]+(-[24][123>+(-[124>+[431>)[23]+[13][432>)<24>)<13>)CWMZ)
