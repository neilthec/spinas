...
//File:  SPINAS/SM/deed.h

namespace spinas {

  class deed : public process {
  private:
    ldouble e;//Electric Charge
    ldouble md, me, mh, wh, MZ, WZ, MW, SW, CW;//Mass of u, s, Higgs, width of Higgs, Z mass, Z width, W-boson mass and sin and cos of the Weinberg angle.
    ...
    ldouble preh, gLd, gRd, gLe, gRe, preZ, preZ0;

    
  public:
    deed(const ldouble& echarge,
	 const ldouble& massd, const ldouble& masse,
