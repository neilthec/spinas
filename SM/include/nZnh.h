...
//File:  SPINAS/SM/nZnh.h

namespace spinas {

  class nZnh : public process {
  private:
  ...
  public:
    //nZnh();
    nZnh(const ldouble& echarge, const ldouble& massh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
