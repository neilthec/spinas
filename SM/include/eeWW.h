...
//File:  SPINAS/SM/eeWW.h

namespace spinas {

  class eeWW : public process {
  private:
    ...
    cdouble pDenhS, pDenneT, pDenneU, pDenZS, pDenAS;
    //<12>,[12],<23>,[23],<13>,[13],<34>,[34],<24>,[24],<14>,[14]
    sproduct s12s, a12a, s23s, a23a, s13s, a13a, s34s, a34a, s24s, a24a, s14s, a14a;
    //[413>,[231>,[132>
    sproduct s413a, s231a, s132a;
    ldouble sqrt2;
    ldouble prene, preh, preZ, gL, gR;

    
  public:
    //eeWW();
    eeWW(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
