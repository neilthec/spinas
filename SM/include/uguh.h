...
//File:  SPINAS/SM/uguh.h

namespace spinas {

  class uguh : public process {
  private:
  ...
  public:
    //uguh();
    uguh(const ldouble& echarge, const ldouble& gscharge, const ldouble& massu, const ldouble& massh, const ldouble& massW, const ldouble& sinW);
