...
//File:  SPINAS/SM/eeee2.h

namespace spinas {

  class eeee2 : public process {
  private:
    ldouble e;//Electric Charge
    ldouble me, mh, wh, MZ, WZ, MW, SW, CW;//Mass of e, Higgs, width of Higgs, Z mass, Z width, W-boson mass and sin and cos of the Weinberg angle.
    particle p1,p2,p3,p4;
    propagator propA, proph, propZ;
    cdouble pDenUA, pDenUh, pDenUZ, pDenTA, pDenTh, pDenTZ;
  ...
  public:
    eeee2(const ldouble& echarge, const ldouble& masse,
