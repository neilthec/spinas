...
//File:  SPINAS/SM/uuhh.h

namespace spinas {

  class uuhh : public process {
  private:
    ldouble e;//Electric Charge
    ldouble mu, mh, wh, MW, SW;//Mass of u, Higgs, width of Higgs, mass of W, sin of Weinberg angle.
    particle p1,p2,p3,p4;
    propagator proph, propu;
    cdouble pDenSh, pDenTu, pDenUu;
    sproduct s12s, a12a, s132a, s231a;
    ldouble prehS, prehTU;

    
  public:
    uuhh(const ldouble& echarge, const ldouble& massu,
