...
//File:  SPINAS/SM/AAWW.h

namespace spinas {

  class AAWW : public process {
  private:
    ldouble e;//Electric Charge
    ldouble MW, SW, CW, WW;//Mass of W, width of W and sin(theta_W) 
    particle p1,p2,p3,p4;
    propagator propW;
    cdouble pDenT, pDenU;
    //[12],<12><34>,[34],<14>,[14],<13>,[13],<24>,[24],<23>,[23]
    sproduct s12s, a12a, a34a, s34s, a14a, s14s, a13a, s13s, s24s, a24a, s23s, a23a;
    ldouble sqrt2;

    
  public:
    //AAWW();
    AAWW(const ldouble& echarge, const ldouble& massW, const ldouble& sinW, const ldouble& widthW);
