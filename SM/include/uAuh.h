...
//File:  SPINAS/SM/uAuh.h

namespace spinas {

  class uAuh : public process {
  private:
  ...
  public:
    //uAuh();
    uAuh(const ldouble& echarge, const ldouble& massu, const ldouble& massh, const ldouble& massW, const ldouble& sinW);
