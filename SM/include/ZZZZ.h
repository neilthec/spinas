...
//File:  SPINAS/SM/ZZZZ.h

namespace spinas {

  class ZZZZ : public process {
  private:
    ldouble e;//Electric Charge
    ldouble mh, wh, MW, SW, CW, MZ;//Mass of h, W and Z, width of h and sin(theta_W)
  ...
  public:
    ZZZZ(const ldouble& echarge, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW);
