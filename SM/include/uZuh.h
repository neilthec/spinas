...
//File:  SPINAS/SM/uZuh.h

namespace spinas {

  class uZuh : public process {
  private:
    ldouble e;//Electric Charge
    ldouble mu, mh, wh, MW, SW, CW, MZ, WZ;//Mass of u and h and W, width of h and Z and sin(theta_W)
    particle p1,p2,p3,p4;
    propagator propZ, propu;
    cdouble pDenS, pDenT, pDenU;
    //<12>,[12],<23>,[23],<13>,[13]
    sproduct s12s, a12a, s23s, a23a, s13s, a13a;    
    //[312>,[213>,[343>,[143>,[341>
    sproduct s213a, s312a, s242a, s142a, s241a;
    ldouble sqrt2;
  ...
  public:
    //uZuh();
    uZuh(const ldouble& echarge, const ldouble& massu, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
