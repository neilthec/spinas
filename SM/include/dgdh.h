...
//File:  SPINAS/SM/dgdh.h

namespace spinas {

  class dgdh : public process {
  private:
  ...
  public:
    //dgdh();
    dgdh(const ldouble& echarge, const ldouble& gscharge, const ldouble& massd, const ldouble& massh, const ldouble& massW, const ldouble& sinW);
