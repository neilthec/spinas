...
//File:  SPINAS/SM/AWWh.h

namespace spinas {

  class AWWh : public process {
  private:
    ...
    //[143>,[142>,[341>,[241>
    sproduct s143a, s142a, s341a, s241a;
    ldouble sqrt2;
    ldouble pre;
  ...
  public:
    //AWWh();
    AWWh(const ldouble& echarge, const ldouble& massh, const ldouble& massW, const ldouble& sinW, const ldouble& widthW);
