...
//File:  SPINAS/SM/dZdh.h

namespace spinas {

  class dZdh : public process {
  private:
  ...
  public:
    //dZdh();
    dZdh(const ldouble& echarge, const ldouble& massd, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
