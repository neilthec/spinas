...
//File:  SPINAS/SM/dZZd.h

namespace spinas {

  class dZZd : public process {
  private:
    ldouble e, Qf;//Electric Charge
    ldouble mf, mh, wh, MW, SW, CW, MZ, WZ;//Mass of f and h and W, width of h and Z and sin(theta_W)
    particle p1,p2,p3,p4;
    propagator proph, propf;
  ...
  public:
    //dZZd();
    dZZd(const ldouble& echarge, const ldouble& massf, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);

    //Set Masses
    void set_masses(const ldouble& massf, const ldouble& massh, const ldouble& massW);
    //Set Momenta
