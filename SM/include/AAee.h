...
//File:  SPINAS/SM/include/AAee.h

namespace spinas {

  class AAee : public process {
  private:
    ...
    sproduct s34s, a34a, s12s, a12a, s13s, a13a, s24s, a24a, s23s, a23a, s14s, a14a, s132a, s231a, s143a, s243a, s214a, s124a, s2421s, s2141s, s2121s;
    ldouble sqrt2;

    
  public:
    //AAee();
    AAee(const ldouble& echarge, const ldouble& masse);
