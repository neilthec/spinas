...
//File:  SPINAS/SM/nnZh.h

namespace spinas {

  class nnZh : public process {
  private:
  ...
  public:
    //nnZh();
    nnZh(const ldouble& echarge, const ldouble& massh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
