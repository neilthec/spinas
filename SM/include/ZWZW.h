...
//File:  SPINAS/SM/ZWZW.h

namespace spinas {

  class ZWZW : public process {
  private:
  ...
  public:
    ZWZW(const ldouble& echarge, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& widthW, const ldouble& sinW);
