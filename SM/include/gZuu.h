...
//File:  SPINAS/SM/gZuu.h

namespace spinas {

  class gZuu : public process {
  private:
  ...
  public:
    //gZuu();
    gZuu(const ldouble& echarge, const ldouble& gscharge, const ldouble& massu, const ldouble& massW, const ldouble& sinW);
