...
//File:  SPINAS/SM/eWWe.h

namespace spinas {

  class eWWe : public process {
  private:
    ldouble e;//Electric Charge
    ldouble me, mh, wh, MW, SW, CW, MZ, WZ;//Mass of e and h and W, width of h and Z and sin(theta_W)
    particle p1,p2,p3,p4;
    propagator proph, propne, propZ, propA;
    cdouble pDenhU, pDenneS, pDenneT, pDenZU, pDenAU;
    //<12>,[12],<23>,[23],<13>,[13],<34>,[34],<24>,[24],<14>,[14]
    sproduct s12s, a12a, s23s, a23a, s13s, a13a, s34s, a34a, s24s, a24a, s14s, a14a;
    //[413>,[231>,[132>
    sproduct s213a, s431a, s134a;
    ldouble sqrt2;
    ldouble prene, preh, preZ, gL, gR, preA;

    
  public:
    //eWWe();
    eWWe(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
