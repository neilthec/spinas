...
//File:  SPINAS/SM/hguu.h

namespace spinas {

  class hguu : public process {
  private:
    ldouble e, gs;//Electric Charge, strong coupling constant
    ldouble mu,mh,MW,SW;//Mass of e and h and W and sin thetaW
  ...
  public:
    //hguu();
    hguu(const ldouble& echarge, const ldouble& gscharge, const ldouble& massu, const ldouble& massh, const ldouble& massW, const ldouble& sinW);
