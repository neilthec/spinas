...
//File:  SPINAS/SM/eZeh.h

namespace spinas {

  class eZeh : public process {
  private:
    ldouble e;//Electric Charge
    ldouble me, mh, wh, MW, SW, CW, MZ, WZ;//Mass of e and h and W, width of h and Z and sin(theta_W)
    particle p1,p2,p3,p4;
    propagator propZ, prope;
    cdouble pDenS, pDenT, pDenU;
    //<12>,[12],<23>,[23],<13>,[13]
    sproduct s12s, a12a, s23s, a23a, s13s, a13a;    
    //[312>,[213>,[242>,[142>,[241>
    sproduct s312a, s213a, s242a, s142a, s241a;
    ldouble sqrt2;
    ldouble preSU, preZ, gL, gR;

    
  public:
    //eZeh();
    eZeh(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
