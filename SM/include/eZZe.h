...
//File:  SPINAS/SM/eZZe.h

namespace spinas {

  class eZZe : public process {
  private:
    ...
    ldouble sqrt2;
    ldouble preTS, preh, gL, gR;

    
  public:
    //eZZe();
    eZZe(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
