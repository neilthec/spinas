...
//File:  SPINAS/SM/eeZZ.h

namespace spinas {

  class eeZZ : public process {
  private:
  ...
  public:
    //eeZZ();
    eeZZ(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
