...
//File:  SPINAS/SM/ddZZ.h

namespace spinas {

  class ddZZ : public process {
  private:
  ...
  public:
    //ddZZ();
    ddZZ(const ldouble& echarge, const ldouble& massf, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
