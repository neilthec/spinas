...
//File:  SPINAS/SM/enmenm.h

namespace spinas {

  class enmenm : public process {
  private:
    ldouble e;//Electric Charge
    ldouble me, MZ, WZ, MW, SW, CW;//Mass of e, Z mass, Z width, W-boson mass and sin and cos of the Weinberg angle.
  ...
  public:
    enmenm(const ldouble& echarge, const ldouble& masse,
