...
//File:  SPINAS/SM/gZdd.h

namespace spinas {

  class gZdd : public process {
  private:
  ...
  public:
    //gZdd();
    gZdd(const ldouble& echarge, const ldouble& gscharge, const ldouble& massd, const ldouble& massW, const ldouble& sinW);
