...
//File:  SPINAS/SM/ZnWe.h

namespace spinas {

  class ZnWe : public process {
  private:
    ...
    sproduct a13a, s13s, a21a, s43s, a23a, s41s, a42a, s412a;
    //<41>,[341>
    sproduct a41a, s341a;
    //[143>
    sproduct s143a;
  ...
  public:
    //ZnWe();
    ZnWe(const ldouble& echarge, const ldouble& masse, const ldouble& massW, const ldouble& sinW, const ldouble& widthW);
