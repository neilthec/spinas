...
//File:  SPINAS/SM/uuWW.h

namespace spinas {

  class uuWW : public process {
  private:
  ...
  public:
    //uuWW();
    uuWW(const ldouble& echarge, const ldouble& massu, const ldouble& massd, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
