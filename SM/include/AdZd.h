...
//File:  SPINAS/SM/AdZd.h

namespace spinas {

  class AdZd : public process {
  private:
    ...
    ldouble sqrt2;
    ldouble preTU, preh, gLd, gRd;

    
  public:
    //AdZd();
    AdZd(const ldouble& echarge, const ldouble& massd, const ldouble& massW, const ldouble& sinW);
