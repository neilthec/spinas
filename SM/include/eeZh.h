...
//File:  SPINAS/SM/eeZh.h

namespace spinas {

  class eeZh : public process {
  private:
  ...
  public:
    //eeZh();
    eeZh(const ldouble& echarge, const ldouble& masse, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
