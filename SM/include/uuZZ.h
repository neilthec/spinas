...
//File:  SPINAS/SM/uuZZ.h

namespace spinas {

  class uuZZ : public process {
  private:
    ldouble e, Qf;//Electric Charge
    ldouble mf, mh, wh, MW, SW, CW, MZ, WZ;//Mass of e and h and W, width of h and Z and sin(theta_W)
  ...
  public:
    //uuZZ();
    uuZZ(const ldouble& echarge, const ldouble& massf, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
