...
//File:  SPINAS/SM/nnWW.h

namespace spinas {

  class nnWW : public process {
  private:
  ...
  public:
    //nnWW();
    nnWW(const ldouble& echarge, const ldouble& masse, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
