...
//File:  SPINAS/SM/hhWW.h

namespace spinas {

  class hhWW : public process {
  private:
  ...
  public:
    //hhWW();
    hhWW(const ldouble& echarge, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthW);
