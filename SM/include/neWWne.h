...
//File:  SPINAS/SM/neWWne.h

namespace spinas {

  class neWWne : public process {
  private:
  ...
  public:
    //neWWne();
    neWWne(const ldouble& echarge, const ldouble& masse, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
