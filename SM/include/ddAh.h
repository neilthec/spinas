...
//File:  SPINAS/SM/ddAh.h

namespace spinas {

  class ddAh : public process {
  private:
    ldouble e, Qd;//Electric Charge
    ldouble md,mh, MW, SW;//Mass of d and h, W and sin theta_W
  ...
  public:
    //ddAh();
    ddAh(const ldouble& echarge, const ldouble& massd, const ldouble& massh, const ldouble& massW, const ldouble& sinW);
