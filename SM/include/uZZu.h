...
//File:  SPINAS/SM/uZZu.h

namespace spinas {

  class uZZu : public process {
  private:
  ...
  public:
    //uZZu();
    uZZu(const ldouble& echarge, const ldouble& massf, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
