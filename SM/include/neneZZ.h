...
//File:  SPINAS/SM/neneZZ.h

namespace spinas {

  class neneZZ : public process {
  private:
    ...
    cdouble pDenT, pDenU;
    //[23], [24], <13>, <14>, <34>
    sproduct s23s, s24s, a13a, a14a, a34a;
    //[314>, [413>
  ...
  public:
    //neneZZ();
    neneZZ(const ldouble& echarge, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
