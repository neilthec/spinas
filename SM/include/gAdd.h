...
//File:  SPINAS/SM/include/gAdd.h

namespace spinas {

  class gAdd : public process {
  private:
    ldouble e, Qd, gs;//Electric Charge and strong coupling
  ...
  public:
    //gAdd();
    gAdd(const ldouble& echarge, const ldouble& gscharge, const ldouble& massd);
    ...
    ldouble amp2();
    ldouble amp2_gplus_Aplus();
    ldouble amp2_gplus_Aminus();
