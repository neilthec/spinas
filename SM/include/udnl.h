...
//File:  SPINAS/SM/udnl.h

namespace spinas {

  class udnl : public process {
  private:
    ...
    cdouble pDenS;
    //[14], <23>, <34>, [12], <12>
    sproduct s14s, a23a, a34a, s12s, a12a;

    
  public:
    udnl(const ldouble& echarge, const ldouble& massu, const ldouble& massd, const ldouble& masstau, const ldouble& massW, const ldouble& widthW, const ldouble& sinW);
