...
//File:  SPINAS/SM/uWWu.h

namespace spinas {

  class uWWu : public process {
  private:
    ...
    propagator proph, propd, propZ, propA;
    cdouble pDenhU, pDendT, pDendS, pDenZU, pDenAU;
    //<12>,[12],<23>,[23],<13>,[13],<34>,[34],<24>,[24],<14>,[14]
    sproduct s12s, a12a, s23s, a23a, s13s, a13a, s34s, a34a, s24s, a24a, s14s, a14a;
    //[213>,[312>,[431>,[134>
    sproduct s213a, s312a, s431a, s134a;
    ldouble sqrt2;
  ...
  public:
    //uWWu();
    uWWu(const ldouble& echarge, const ldouble& massu, const ldouble& massd, const ldouble& massh, const ldouble& widthh, const ldouble& massW, const ldouble& sinW, const ldouble& widthZ);
