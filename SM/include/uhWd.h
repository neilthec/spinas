...
//File:  SPINAS/SM/uhWd.h

namespace spinas {

  class uhWd : public process {
  private:
    ...
    //<13>,[43],<14>,[14],[323>
    sproduct a13a, s43s, a14a, s14s, s323a;
    //<13>,[43],[324>
    sproduct s324a;
    //[43],<13>,[123>
    sproduct s123a;
  ...
  public:
    //uhWd();
    uhWd(const ldouble& echarge, const ldouble& massu, const ldouble& massd, const ldouble& massh, const ldouble& massW, const ldouble& widthW, const ldouble& sinW);
