...
//File:  SPINAS/SM/guZu.h

namespace spinas {

  class guZu : public process {
  private:
    ldouble e, Qu, gs;//Electric strong Charge
  ...
  public:
    //guZu();
    guZu(const ldouble& echarge, const ldouble& gscharge, const ldouble& massu, const ldouble& massW, const ldouble& sinW);
