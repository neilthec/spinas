...
namespace spinas {
  ...
  //Normalization Factor
    ...
    void print_test_message(const char *frame_string, const ldouble &m1, const ldouble &m2, const ldouble &m3, const ldouble &m4, const ldouble &ampSquared, const ldouble &reference, const ldouble &cost) const;
